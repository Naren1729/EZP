...
public class UserService implements UserInterface {
    ...
    @Autowired
    private EncryptionBOService encryptionservice; // Service for encrypting user data
    
    @Autowired
    private DecryptionBOService decryptionservice; // Service for decrypting user data
    ...
    public boolean checkPassword(String username, String password) {
        ...
        Optional<User> user = userRepo.findByUsername(encryptedUsername);
        if (user.isPresent()) {
