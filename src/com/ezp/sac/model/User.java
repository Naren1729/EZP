...
public class User {
    ...
    public String password; // Password for the user

    // Transaction details
    public Long transaction_id; // Unique ID for the transaction
    public String type; // Type of transaction
    public Double amount; // Amount involved in the transaction
    public LocalDateTime date; // Date and time of the transaction
    public String status; // Status of the transaction (e.g., Pending, Completed)
