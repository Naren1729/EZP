...
//        TransactionDetails resultValid = transactionService.flagTransaction(validTransaction);
//
//        
//        assertNotNull(resultValid);
//        assertEquals("Success", resultValid.getTransactionStatus());
...
//        transactionDetails.setDestinationUserId(destinationId);
//        transactionDetails.setTransactionTime(date);
...
//        when(userService.findById(destinationId)).thenReturn(destinationUser);
//        when(transactionRepo.findByUsernIdAndDestinationUserIdAndTransactionTimeBetween(anyLong(), anyLong(), any(LocalDateTime.class), any(LocalDateTime.class)))
...
//        assertEquals(new BigDecimal("100"), riskScore);
//    }
//}
